...
public class MailServiceDemo {
	...
	public void sendMail(SimpleMailMessage mailDao) {
		...
		SendEmailRequest request = new SendEmailRequest().withReplyToAddresses(mailDao.getReplyTo()).withDestination(destination).withMessage(message)
				.withSource(from);
